...
public class EmbeddedDatasetConfiguration extends AbstractDatasetConfiguration {
  ...
  public EmbeddedDatasetConfiguration(String offheapResource, String diskResource, Map<CellDefinition<?>, IndexSettings> indexes) {
    this(offheapResource, diskResource, indexes, null);
  }

  public EmbeddedDatasetConfiguration(String offheapResource, String diskResource, Map<CellDefinition<?>, IndexSettings> indexes, Integer concurrencyHint) {
    super(offheapResource, diskResource, indexes, concurrencyHint, null, null);
  }

  public EmbeddedDatasetConfiguration(String offheapResource, String diskResource, Map<CellDefinition<?>,
