...
public class MuxDatasetDiscoveryListener implements DatasetDiscoveryListener {
  ...
  public MuxDatasetDiscoveryListener(DatasetDiscoveryListener... listeners) {
    this(Arrays.asList(listeners));
  }

  public MuxDatasetDiscoveryListener(List<DatasetDiscoveryListener> listeners) {
  ...
  public <K extends Comparable<K>> void foundExistingDataset(String diskResourceName, SovereignDataset<K> dataset) throws StoreException {
    for (DatasetDiscoveryListener listener : listeners) {
