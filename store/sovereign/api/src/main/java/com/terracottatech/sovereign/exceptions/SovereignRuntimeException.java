...
public abstract class SovereignRuntimeException extends RuntimeException {
  ...
  public SovereignRuntimeException(String message) {
    super(message);
  }

  public SovereignRuntimeException(String message, Throwable cause) {
    super(message, cause);
  }

  public SovereignRuntimeException(Throwable cause) {
    super(cause);
  }
}
