 ...
 * <p>
 * The methods in this class do <b>not</b> handle {@code null} {@code String} values; nulls are not expected
 * in {@link com.terracottatech.store.Cell Cell} values.
 * <p>
...
public final class StringTool {
   ...
   * @throws BufferUnderflowException if {@code buffer} is too small to hold the declared UTF value
   */
  public static String decodeString(final ByteBuffer buffer, final long encodedLength)
      throws UTFDataFormatException, BufferUnderflowException {
  ...
  public static void putUTF(final ByteBuffer buffer, final String str)
      throws ReadOnlyBufferException, BufferOverflowException {
    Objects.requireNonNull(buffer, "buffer");
   ...
   * @throws ReadOnlyBufferException if {@code buffer} is read-only
   */
  public static void putEncoded(final ByteBuffer buffer, final String str, final int strLength)
   ...
   * @throws ReadOnlyBufferException if {@code buffer} is read-only
   */
  private static void putNonEncoded(final ByteBuffer buffer, final String str, final int strLength)
      throws BufferOverflowException, ReadOnlyBufferException  {
   ...
   * @throws ReadOnlyBufferException if {@code buffer} is read-only
   */
  private static void putASCII(final ByteBuffer buffer, final String str, final long rawEncodedLength, final int strLength)
      throws BufferOverflowException, ReadOnlyBufferException {
