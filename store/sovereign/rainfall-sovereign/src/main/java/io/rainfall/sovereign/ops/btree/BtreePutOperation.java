...
public class BtreePutOperation extends SovereignOperation<Long, Long> {

  public BtreePutOperation() {
    super(SovereignResult.ADD);
  }
  ...
  public void exec(StatisticsHolder stats, Map<Class<? extends Configuration>, Configuration> configurations,
    ...
    try {
      ...
      stats.record(getClass().getSimpleName(), (end - start), SovereignResult.ADD);
    } catch (Throwable e) {
      long end = getTimeInNs();
