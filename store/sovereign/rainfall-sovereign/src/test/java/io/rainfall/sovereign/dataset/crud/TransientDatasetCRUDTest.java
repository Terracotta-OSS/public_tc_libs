 ...
 * @author cschanck
 **/
public class TransientDatasetCRUDTest extends AbstractDatasetTest {
  ...
  public void before() {
    ...
    this.ds = new SovereignBuilder<>(Type.LONG, FixedTimeReference.class)
      .offheap()
      .limitVersionsTo(1)
      .concurrency(NUM_THREADS*2)
      .build();
  ...
  @Test
  public void testTransientCRUD() throws SyntaxException {
    config.setDescription("Transient CRUD");
    runAddReplaceGetDelete(config, "transient", .3, .4, .3);
  }
