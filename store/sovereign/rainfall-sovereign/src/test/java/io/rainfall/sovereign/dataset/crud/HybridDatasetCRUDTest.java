 ...
 * @author cschanck
 **/
public class HybridDatasetCRUDTest extends AbstractDatasetTest {
  ...
  @Test
  public void testHybridCRUD() throws SyntaxException {
    runAddReplaceGetDelete(config, "hybrid", .3, .4, .3);
  }

  @Test
  @Ignore
  public void testHybridPut() throws SyntaxException {
    config.setDescription("Hybrid CRUD");
    runAddOrReplace(config, "hybrid");
  }
