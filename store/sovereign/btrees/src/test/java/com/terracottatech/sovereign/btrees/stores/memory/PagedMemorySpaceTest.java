...
public class PagedMemorySpaceTest extends AbstractSimpleStoreTestBase {

  private PagedMemorySpace sa;

  @Override
  public SimpleStore getSimpleStoreReaderWriter() throws IOException {
    if (sa == null) {
      sa = new PagedMemorySpace(PageSourceLocation.offheap(), 4096, 128 * 1024, 1024 * 1024 * 1024);
    }
    return sa;
  }
}
