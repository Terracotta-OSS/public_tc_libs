...
public class OffHeapStorageAreaBasedSpaceTest extends AbstractSimpleStoreTestBase {

  private OffHeapStorageAreaBasedSpace sa=null;
  @Override
  public SimpleStore getSimpleStoreReaderWriter() throws IOException {
    if(sa==null) {
      sa = new OffHeapStorageAreaBasedSpace(PageSourceLocation.offheap(), 1024);
    }
    return sa;
  }
}
