 ...
 * @author cschanck
 **/
public interface SovereignIndexMap<K extends Comparable<K>, RK extends Comparable<RK>> extends IndexMap<K, RK, ContextImpl, PersistentMemoryLocator> {

  @Override
  SovereignRuntime<?> runtime();

  long getOccupiedStorageSize();

  long getAllocatedStorageSize();

  long statAccessCount();
