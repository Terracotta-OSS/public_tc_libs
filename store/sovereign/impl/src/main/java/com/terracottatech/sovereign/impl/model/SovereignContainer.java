 ...
 */
public interface SovereignContainer<K extends Comparable<K>>
  extends DataContainer<ContextImpl, PersistentMemoryLocator, SovereignPersistentRecord<K>>,
  SovereignValueGenerator {
