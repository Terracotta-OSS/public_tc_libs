 ...
 */
public interface SovereignSortedIndexMap<K extends Comparable<K>, RK extends Comparable<RK>> extends
        SovereignIndexMap<K, RK>, SortedIndexMap<K, RK,
  ContextImpl,
  PersistentMemoryLocator> {
  ...
  interface BatchHandle<KK extends Comparable<KK>> {
    void batchAdd(Object recordKey, KK key, PersistentMemoryLocator pointer);
