...
public class BatchQuick3SortTest extends AbstractSortTest {
  @Rule
  public TemporaryFolder tmp = new TemporaryFolder();

  @Override
  public SortArea<ByteBuffer> makeArea() throws IOException {
    //return SortArea.areaOf(new OffheapSortIndex(4096), new SortScratchPad.Naive());
  ...
  public void sort(SortArea<ByteBuffer> a, Comparator<ByteBuffer> comp) throws IOException {
    new BatchQuick3Sort().sort(a, comp);
  }
