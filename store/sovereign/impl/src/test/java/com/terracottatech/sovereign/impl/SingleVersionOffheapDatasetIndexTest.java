 ...
 * @author cschanck
 */
public class SingleVersionOffheapDatasetIndexTest extends AbstractDatasetIndexTest {

  @Override
  public void createBucket() {
    setDataset(new SovereignBuilder<>(Type.STRING, SystemTimeReference.class)
        .offheap()
        .concurrency(8)
        .limitVersionsTo(1)
