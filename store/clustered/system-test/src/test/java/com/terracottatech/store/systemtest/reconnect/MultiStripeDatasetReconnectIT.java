...
public class MultiStripeDatasetReconnectIT extends DatasetReconnectIT {

  @ClassRule
  public static EnterpriseCluster CLUSTER = newCluster(1, 1).withPlugins(RESOURCE_CONFIG).build();
  ...
  protected ClusterDelay getDelay() {
    return new ClusterDelay("datasetDelay", 2);
  }

  @Test
  public void runTestWhenOneConnectionInMultiStripeGetsDelayed() throws Exception {
    testReconnectWithCRUD((time, delay) -> delay.getStripeDelay(0).setDefaultMessageDelay(time));
  }
