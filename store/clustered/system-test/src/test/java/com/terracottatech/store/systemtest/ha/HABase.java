...
public abstract class HABase extends BaseSystemTest {
  ...
  protected enum ConfigType {
    ...
    protected ClusteredDatasetManagerBuilder getDatasetManagerBuilder() {
      return DatasetManager.clustered(getInetSocketAddresses(HABase.CLUSTER.getClusterHostPorts()));
    }
  ...
  public HABase(ConfigType configType) {
