...
public abstract class RestartabilityStorageFactory extends PersistentStorageFactory {

  private final DatasetStorageManagement datasetStorageManagement;

  public RestartabilityStorageFactory(BufferResourceFactory bufferResourceFactory,
    ...
    super(bufferResourceFactory, dataRootConfig, backupCoordinatorFactory);
    this.datasetStorageManagement = datasetStorageManagement;
  }

  @Override
  protected void deRegisterStorageManagement() {
    datasetStorageManagement.deRegisterRestartStore();
  }

  @Override
  protected void setupStorageManagement(AbstractPersistentStorage storage, String diskResource, Path storeRoot) {
    AbstractRestartabilityBasedStorage restartabilityBasedStorage = (AbstractRestartabilityBasedStorage) storage;
    datasetStorageManagement.registerRestartStore(storeRoot, restartabilityBasedStorage.getDatasetStore(), diskResource);
  }
}
