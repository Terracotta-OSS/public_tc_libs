...
@Named("DatasetPersistenceStatistics")
@RequiredContext({@Named("consumerId"), @Named("type"), @Named("alias")})
@StatisticProvider
@CommonComponent
public class DatasetPersistenceStatisticsManagementProvider extends AbstractStatisticsManagementProvider<RestartStoreBinding> {
  public DatasetPersistenceStatisticsManagementProvider() {
  ...
  private static class RestartStoreBindingExposedStatistics extends AbstractExposedStatistics<RestartStoreBinding> {
    RestartStoreBindingExposedStatistics(Context context, RestartStoreBinding binding, StatisticRegistry statisticRegistry) {
      super(context.with("type", "DatasetRestartStore"), binding, statisticRegistry);
