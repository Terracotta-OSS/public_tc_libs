...
final class ClientStateBinding extends ClientBinding {
  ...
  ClientStateBinding(ClientDescriptor clientDescriptor) {
    super(clientDescriptor, clientDescriptor);
  }

  @Override
  public ClientDescriptor getValue() {
    return (ClientDescriptor) super.getValue();
  }
