...
/**
 * Abstract factory that churns out backup coordinator on demand.
 */
public interface BackupCoordinatorFactory {
  BackupCapable create();
  void setupBackupManagementFor(AbstractPersistentStorage storage, String diskResource, Path dataRoot,
