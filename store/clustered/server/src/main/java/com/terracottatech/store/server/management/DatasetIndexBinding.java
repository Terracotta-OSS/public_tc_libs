...
public class DatasetIndexBinding extends AliasBinding {

  private final SovereignIndex<?> index;

  public DatasetIndexBinding(SovereignIndex<?> index, DatasetEntityConfiguration<?> datasetEntityConfiguration) {
    super(datasetEntityConfiguration.getDatasetName() + ":" + index.getDescription().getCellName(), datasetEntityConfiguration);
    this.index = index;
  }
  ...
  public SovereignIndex<?> getIndex() {
    return index;
  }
}
