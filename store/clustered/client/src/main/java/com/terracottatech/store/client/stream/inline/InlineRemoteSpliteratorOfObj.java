...
/**
 * Defines a {@link Spliterator} returning object elements sourced from a remote
 ...
 */
public class InlineRemoteSpliteratorOfObj<K extends Comparable<K>, T>
    extends AbstractInlineRemoteSpliterator<K, T> {

  /**
   * Creates a new {@code InlineRemoteSpliteratorOfObj} against the remote {@link com.terracottatech.store.Dataset Dataset}.
   *
   * <h3>Implementation Note</h3>
   * The element types supported by this {@code Spliterator} are limited to those supported by
   ...
   */
  public InlineRemoteSpliteratorOfObj(MessageSender messageSender, UUID streamId, RootStreamDescriptor descriptor,
  ...
  public boolean tryAdvance(Consumer<? super T> action) {
    ...
    return this.consume((fetchApplyResponse -> action.accept(decodeElement(fetchApplyResponse.getElement()))));
  }
}
