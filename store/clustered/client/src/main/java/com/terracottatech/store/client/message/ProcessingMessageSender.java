...
public class ProcessingMessageSender implements MessageSender {
  private final MessageSender underlying;
  private final ResponseProcessor processor;

  public ProcessingMessageSender(MessageSender underlying, ResponseProcessor processor) {
  ...
  public <R extends DatasetEntityResponse> Future<R> sendMessage(DatasetEntityMessage message, SendConfiguration configuration) {
    Future<DatasetEntityResponse> future = underlying.sendMessage(message, configuration);
    return new ResponseProcessingFuture<>(future, processor);
  }
  ...
  public <R extends DatasetEntityResponse> R sendMessageAwaitResponse(DatasetEntityMessage message, SendConfiguration configuration) {
    DatasetEntityResponse response = underlying.sendMessageAwaitResponse(message, configuration);
