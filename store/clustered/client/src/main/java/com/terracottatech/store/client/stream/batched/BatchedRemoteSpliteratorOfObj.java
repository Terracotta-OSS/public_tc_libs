 ...
 */
public class BatchedRemoteSpliteratorOfObj<T>
    extends AbstractBatchedRemoteSpliterator<T> {

  /**
   * Creates a new {@code BatchedRemoteSpliteratorOfObj} against the remote {@link com.terracottatech.store.Dataset Dataset}.
   *
   ...
   */
  public BatchedRemoteSpliteratorOfObj(MessageSender messageSender, UUID streamId, RootStreamDescriptor descriptor,
