...
/**
 * Defines a {@link RemoteSpliterator.OfInt} returning elements sourced from a remote
 ...
 */
public class InlineRemoteSpliteratorOfInt<K extends Comparable<K>>
    extends AbstractInlineRemoteSpliterator<K, Integer>
    implements RemoteSpliterator.OfInt {

  /**
   * Create a new {@code InlineRemoteSpliteratorOfInt} against the remote {@link com.terracottatech.store.Dataset Dataset}.
   *
   ...
   */
  public InlineRemoteSpliteratorOfInt(MessageSender messageSender, UUID streamId, RootStreamDescriptor descriptor,
                                      BooleanSupplier closeUsingServer) {
    super(messageSender, streamId, descriptor, closeUsingServer);
  }

  @Override
  public RemoteSpliterator.OfInt trySplit() {
  ...
  public boolean tryAdvance(IntConsumer action) {
    ...
    return this.consume((fetchApplyResponse -> {
      int element = fetchApplyResponse.getElement().getIntValue();
