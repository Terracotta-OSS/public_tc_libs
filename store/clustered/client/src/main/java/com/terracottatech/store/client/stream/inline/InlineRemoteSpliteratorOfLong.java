...
/**
 * Defines a {@link RemoteSpliterator.OfLong} returning elements sourced from a remote
 ...
 */
public class InlineRemoteSpliteratorOfLong<K extends Comparable<K>>
    extends AbstractInlineRemoteSpliterator<K, Long>
    implements RemoteSpliterator.OfLong {

  /**
   * Creates a new {@code InlineRemoteSpliteratorOfLong} against the remote {@link com.terracottatech.store.Dataset Dataset}.
   *
   ...
   */
  public InlineRemoteSpliteratorOfLong(MessageSender messageSender, UUID streamId, RootStreamDescriptor descriptor,
                                       BooleanSupplier closeUsingServer) {
    super(messageSender, streamId, descriptor, closeUsingServer);
  }

  @Override
  public RemoteSpliterator.OfLong trySplit() {
  ...
  public boolean tryAdvance(LongConsumer action) {
    ...
    return this.consume((fetchApplyResponse -> {
      long element = fetchApplyResponse.getElement().getLongValue();
