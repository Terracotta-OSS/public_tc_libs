...
/**
 * Defines a {@link OfInt} returning elements sourced from a remote
 * {@link com.terracottatech.store.Dataset Dataset} accessed via a {@link DatasetEntity}.
 */
public class BatchedRemoteSpliteratorOfInt
    extends AbstractBatchedRemoteSpliterator<Integer>
    implements RemoteSpliterator.OfInt {

  /**
   * Creates a new {@code BatchedRemoteSpliteratorOfInt} against the remote {@link com.terracottatech.store.Dataset Dataset}.
   *
   ...
   * @param descriptor a descriptor of the root {@link Stream} for which the {@code Spliterator.OfInt} was opened
   ...
   */
  public BatchedRemoteSpliteratorOfInt(MessageSender messageSender, UUID streamId, RootStreamDescriptor descriptor,
  ...
  public Spliterator.OfInt trySplit() {
    ...
    if (available == null) {
      ...
      return available.mapToInt(Element::getIntValue).spliterator();
    }
  }
  ...
  public boolean tryAdvance(IntConsumer action) {
    ...
    return consume(element -> action.accept(element.getIntValue()));
  }

  @Override
  public void forEachRemaining(IntConsumer action) {
    requireNonNull(action, "action");
    consumeAll(element -> action.accept(element.getIntValue()));
  }

  @Override
  protected Integer decodeElement(Element element) {
