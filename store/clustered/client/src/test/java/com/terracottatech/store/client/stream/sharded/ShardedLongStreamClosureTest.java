...
import com.terracottatech.store.client.stream.AbstractLongStreamClosureTest;
...
public class ShardedLongStreamClosureTest extends AbstractLongStreamClosureTest {
  ...
  protected LongStream getStream() {
    ...
    return new ShardedLongStream(shards, null, 0, source);
  }
