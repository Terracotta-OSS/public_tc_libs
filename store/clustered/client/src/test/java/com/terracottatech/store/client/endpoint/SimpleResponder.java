...
public class SimpleResponder implements Responder {
  ...
  public SimpleResponder(DatasetEntityResponse response) {
    this.response = response;
  }

  @Override
  public DatasetEntityResponse respond(DatasetEntityMessage message) {
  ...
  public DatasetEntityMessage getMessage() {
    return message;
  }
}
