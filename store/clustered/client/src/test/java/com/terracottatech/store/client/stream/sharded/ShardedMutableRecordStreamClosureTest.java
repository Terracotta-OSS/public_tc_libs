...
public class ShardedMutableRecordStreamClosureTest extends AbstractStreamClosureTest<Record<String>> {
  ...
  protected Stream<Record<String>> getStream() {
    ...
    return new ShardedMutableRecordStream<String>(shards, 0, source);
  }
