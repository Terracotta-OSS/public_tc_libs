...
public class PredicatedUpdateRecordSimplifiedResponse extends DatasetEntityResponse {

  private final boolean updated;

  public PredicatedUpdateRecordSimplifiedResponse(boolean updated) {
    super();
  ...
  public DatasetEntityResponseType getType() {
    return DatasetEntityResponseType.PREDICATED_UPDATE_RECORD_SIMPLIFIED_RESPONSE;
  }
  ...
  public static Struct struct(DatasetStructBuilder builder) {
    return builder.bool("updated", 20).build();
  }

  public static void encode(DatasetStructEncoder encoder, DatasetEntityResponse response) {
    PredicatedUpdateRecordSimplifiedResponse updateResponse = (PredicatedUpdateRecordSimplifiedResponse) response;
    encoder.bool("updated", updateResponse.isUpdated());
  }

  public static PredicatedUpdateRecordSimplifiedResponse decode(DatasetStructDecoder decoder) {
    boolean updated = decoder.bool("updated");
