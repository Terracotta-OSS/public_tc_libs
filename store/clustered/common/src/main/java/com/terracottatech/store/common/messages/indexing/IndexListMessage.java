...
import static com.terracottatech.store.common.messages.DatasetOperationMessageType.INDEX_LIST_MESSAGE;

public class IndexListMessage extends UniversalMessage {

  public static final IndexListMessage INSTANCE = new IndexListMessage();
  ...
  public static IndexListMessage decode(DatasetStructDecoder decoder) {
    return INSTANCE;
  }
}
