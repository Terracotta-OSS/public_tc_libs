...
public class AddRecordSimplifiedResponse extends DatasetEntityResponse {
  private final boolean added;

  public AddRecordSimplifiedResponse(boolean added) {
    this.added = added;
  }
  ...
  public DatasetEntityResponseType getType() {
    return DatasetEntityResponseType.ADD_RECORD_SIMPLIFIED_RESPONSE;
  }

  public static Struct struct(DatasetStructBuilder builder) {
    return builder.bool("added", 20).build();
  }

  public static void encode(DatasetStructEncoder encoder, DatasetEntityResponse response) {
    AddRecordSimplifiedResponse addResponse = (AddRecordSimplifiedResponse) response;
    encoder.bool("added", addResponse.isAdded());
  }

  public static AddRecordSimplifiedResponse decode(DatasetStructDecoder decoder) {
    return new AddRecordSimplifiedResponse(decoder.bool("added"));
  }
}
