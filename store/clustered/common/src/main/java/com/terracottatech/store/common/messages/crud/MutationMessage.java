...
public abstract class MutationMessage<K extends Comparable<K>> extends KeyMessage<K> {
  private final UUID stableClientId;
  private final ChangeType changeType;
  private final boolean respondInFull;

  public MutationMessage(UUID stableClientId, K key, ChangeType changeType, boolean respondInFull) {
    super(key);
