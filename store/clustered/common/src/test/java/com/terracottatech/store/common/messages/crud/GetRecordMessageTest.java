...
public class GetRecordMessageTest {
  @Test
  public void hasGetRecordMessageType() {
    GetRecordMessage<String> message = new GetRecordMessage<>("key", AlwaysTrue.alwaysTrue());
    Assert.assertEquals(DatasetOperationMessageType.GET_RECORD_MESSAGE, message.getType());
  }

  @Test
  public void givesCorrectKey() {
    GetRecordMessage<String> message = new GetRecordMessage<>("key", AlwaysTrue.alwaysTrue());
