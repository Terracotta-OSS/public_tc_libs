...
import static com.terracottatech.store.ExplanationAssertions.*;
...
import static com.terracottatech.store.common.dataset.stream.PipelineOperation.IntermediateOperation.LONG_FILTER;
...
import static com.terracottatech.store.server.StreamStrategy.INLINE;
...
/**
 * Tests the single-stripe remote {@link Stream} functions of {@link DatasetActiveEntity}.
 */
@SuppressWarnings("Duplicates")
@RunWith(Parameterized.class)
public class RemoteStreamTest extends PassthroughTest {
  ...
  public RemoteStreamTest(StreamStrategy strategy) {
  ...
  public void testUnconsumedStreamExplanation() throws StoreException {
    ...
    try (Stream<String> stream = streamStrategy.stream(access)
        .explain(explanationMatches(allOf(
            serverSidePipeline(streamStrategy.ignoringPrefix(streamStrategy.ignoringPrefix(containsOperations(op(FILTER))))),
            clientSideStripePipeline(containsOperations(op(MAP), op(SPLITERATOR))),
  ...
  public void remoteFilterTest() throws StoreException {
    ...
    assertThat(result.size(), is((int) ANIMALS.stream().filter(a -> a.getTaxonomicClass().equals("mammal")).count()));
    assertThat(result, everyItem(is(equalTo("mammal"))));
  }

  @Test
  public void testFullyPortableStream() throws StoreException {
    DatasetWriterReader<String> access = dataset.writerReader();
    ...
    assertThat(result, is(ANIMALS.stream().filter(a -> a.getTaxonomicClass().equals("mammal")).count()));
  }
  ...
  public void remoteMapToLongTest() throws StoreException {
    ...
    assertThat(result.size(), is(ANIMALS.size()));
  }
  ...
  public void remoteKeyExtraction() throws StoreException {
    ...
    assertThat(result, is(ANIMALS.stream().map(Animals.Animal::getName).collect(toSet())));
  }
  ...
  public void testLongPipeline() throws Exception {
    ...
    List<Long> mammalStatus = recordStream
        .explain(explanationMatches(allOf(
            serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(FILTER), op(MAP_TO_INT), op(AS_LONG_STREAM), op(SORTED_0), op(DISTINCT), op(BOXED), op(SKIP), op(LIMIT), op(UNORDERED)))),
            clientSideStripePipeline(containsOperations(op(COLLECT_1))),
            clientSideMergedPipeline(empty()))))
        .filter(TAXONOMIC_CLASS.value().is("mammal"))
  ...
  public void testLongishPipeline() throws Exception {
    ...
    List<String> mammalStatus = recordStream
        .explain(explanationMatches(allOf(
            serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(FILTER), op(MAP), op(SORTED_0), op(DISTINCT), op(SKIP), op(LIMIT), op(UNORDERED)))),
            clientSideStripePipeline(containsOperations(op(COLLECT_1))),
            clientSideMergedPipeline(empty()))))
  ...
  public void testFullCycle() throws Exception {
    ...
    assertThat(animals, containsInAnyOrder(ANIMALS.toArray()));
  }
  ...
  public void testSummarizingLongCollector() throws Exception {
    ...
    LongSummaryStatistics stats = records
        .explain(explanationMatches(allOf(
            ...
            clientSideStripePipeline(empty()),
            clientSideMergedPipeline(empty()))))
        .collect(Collectors.summarizingLong(OBSERVATIONS.longValueOr(0L)));
    assertThat(stats.getCount(), is(88L));
  ...
  public void testSummarizingDoubleCollector() throws Exception {
    ...
    assertThat(stats.getCount(), is(88L));
    assertThat(stats.getSum(), closeTo(ANIMALS.stream().mapToDouble(a -> a.getMass() == null ? 0.0 : a.getMass()).sum(), 0.005));
    assertThat(stats.getMin(), is(0.0));
    assertThat(stats.getMax(), closeTo(ANIMALS.stream().mapToDouble(a -> a.getMass() == null ? 0.0 : a.getMass()).max().getAsDouble(), 0.005));
  }
  ...
  public void testTerminalPortability() throws Exception {
...

    {
      ...
      Optional<Record<String>> first = records
          .explain(explanationMatches(allOf(
              serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(FIND_FIRST)))),
              clientSideStripePipeline(empty()),
              clientSideMergedPipeline(empty()))))
          .findFirst();
    ...
    }
    {
      ...
      OptionalLong firstL = records
          .explain(explanationMatches(allOf(
              serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(MAP_TO_LONG), op(FIND_FIRST)))),
              clientSideStripePipeline(empty()),
              clientSideMergedPipeline(empty()))))
          .mapToLong(OBSERVATIONS.longValueOr(0L)).findFirst();
      assertThat(firstL.getAsLong(), is(3L));
    }
    {
      RecordStream<String> records = streamStrategy.stream(writerReader);
      try {
        records
            .explain(explanationMatches(allOf(
                serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(MAP_TO_INT), op(FIND_FIRST)))),
                clientSideStripePipeline(empty()),
                clientSideMergedPipeline(empty()))))
            .mapToInt(STATUS_LEVEL.intValueOrFail()).findFirst();
        fail();
      } catch (NoSuchElementException e) {
        // expected
      }
    }
    {
      ...
      Optional<Optional<Long>> firstR = records
          .explain(explanationMatches(allOf(
              serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(MAP), op(FIND_FIRST)))),
              clientSideStripePipeline(empty()),
              clientSideMergedPipeline(empty()))))
          .map(OBSERVATIONS.value()).findFirst();
      assertThat(firstR.get().get(), is(3L));
    }
    {
      RecordStream<String> records = streamStrategy.stream(writerReader);
      Optional<Optional<Long>> firstR = records
    ...
    }
    {
      ...
      assertThat(max.getAsDouble(), is(ANIMALS.stream().mapToDouble(a -> a.getMass() == null ? 0.5 : a.getMass()).max().getAsDouble()));
    }
    {
      RecordStream<String> records = streamStrategy.stream(writerReader);
      ...
      assertThat(min.getAsDouble(), is(ANIMALS.stream().mapToDouble(a -> a.getMass() == null ? 0.5 : a.getMass()).min().getAsDouble()));
    }
    {
      RecordStream<String> records = streamStrategy.stream(writerReader);
  ...
  public void testAsComparator() throws Exception {
    ...
    List<String> taxonomies = taxonomyStream
        .explain(explanationMatches(allOf(
            serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(SORTED_1), op(MAP), op(DISTINCT)))),
            clientSideStripePipeline(containsOperations(op(COLLECT_1))),
            clientSideMergedPipeline(empty()))))
        ...
        .distinct()
        .collect(toList());
    assertThat(taxonomies, contains(ANIMALS.stream()
    ...
    long[] observations = observationStream
        .explain(explanationMatches(allOf(
            ...
            clientSideStripePipeline(containsOperations(op(TO_ARRAY_0))),
            clientSideMergedPipeline(empty()))))
        .mapToLong(OBSERVATIONS.longValueOr(-999L))
        .sorted()
        .distinct()
        .toArray();
    assertThat(observations, is(ANIMALS.stream()
  ...
  public void testDoubleStreamPortability() throws Exception {
    ...
    double mammalObservations = recordStream
        ...
        .sum();
    assertThat(mammalObservations, is(ANIMALS.stream()
  ...
  public void testIntStreamPortability() throws Exception {
    ...
    int mammalLevels = recordStream
        ...
        .sum();
    assertThat(mammalLevels, is(ANIMALS.stream()
        .filter(a -> a.getTaxonomicClass().equals("mammal"))
  ...
  @Ignore("If the OS allows creating more threads than what can fit in RAM, the JVM will crash")
  @Test
  public void testPipelineProcessorExecutorExhaustion() throws Exception {
    // batched modes will blow the heap before this test runs out of threads
    assumeThat(streamStrategy, is(INLINE));
    ...
    openLoop:
    {
      for (long i = Integer.MAX_VALUE * 2L; i > 0; i--) {
        try {
          ...
          remoteData.next();        // Force opening of remote element source
          openStreams.add(recordStream);
        } catch (RejectedExecutionException e) { // shouldn't that be StoreBusyException?
          break openLoop;
        }
      }
      fail("Expecting RejectedExecutionException");   // Bump iteration count?
    }
    assertThat(openStreams, is(not((empty()))));

    // close the last created stream to make it free its thread, then make sure we can spawn a thread
    openStreams.remove(openStreams.size() - 1).close();
    new Thread().start();

    // then close all remaining streams
    openStreams.forEach(BaseStream::close);
  }
  ...
  public void testCloseBeforeStarted() throws Exception {
    ...
    animalStream.close();
    try {
      @SuppressWarnings("unused") RecordStream<String> mammalStream = animalStream
          .filter(TAXONOMIC_CLASS.value().is("mammal"));
  ...
  public void testPortableLimitSkip() throws Exception {
    ...
    List<Animals.Animal> someMammals = recordStream
        .explain(explanationMatches(allOf(
            serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(FILTER), op(SKIP), op(LIMIT)))),
            clientSideStripePipeline(containsOperations(op(MAP), op(COLLECT_1))),
            clientSideMergedPipeline(empty()))))
        .filter(TAXONOMIC_CLASS.value().is("mammal"))
        .skip(5)
    ...
    assertThat(someMammals, everyItem(isIn(ANIMALS)));
  }
  ...
  public void testNonPortableSorted() throws Exception {
    ...
    List<Animals.Animal> someMammals = recordStream
        .explain(explanationMatches(allOf(
            serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(FILTER)))),
            clientSideStripePipeline(containsOperations(op(SORTED_1), op(MAP), op(COLLECT_1))),
            clientSideMergedPipeline(empty()))))
        .filter(TAXONOMIC_CLASS.value().is("mammal"))
  ...
  @Test
  public void testCollectGroupByWithReducingCollector() {
    DatasetWriterReader<String> writerReader = dataset.writerReader();
    RecordStream<String> recordStream = streamStrategy.stream(writerReader);
  ...
  @Test
  public void testCollectGroupByWithIdentityCollector() {
    DatasetWriterReader<String> writerReader = dataset.writerReader();
    RecordStream<String> recordStream = streamStrategy.stream(writerReader);
  ...
  @Test
  public void testCollectGroupByConcurrent() {
    DatasetWriterReader<String> writerReader = dataset.writerReader();
    RecordStream<String> recordStream = streamStrategy.stream(writerReader);
  ...
  @Test
  public void testCollectPartitionByWithReducingCollector() {
    DatasetWriterReader<String> writerReader = dataset.writerReader();
    RecordStream<String> recordStream = streamStrategy.stream(writerReader);
  ...
  @Test
  public void testCollectPartitionByWithIdentityCollector() {
    DatasetWriterReader<String> writerReader = dataset.writerReader();
    RecordStream<String> recordStream = streamStrategy.stream(writerReader);
  ...
  @Test
  public void testCollectFiltering() {
    DatasetWriterReader<String> writerReader = dataset.writerReader();
    RecordStream<String> recordStream = streamStrategy.stream(writerReader);
    Long mammalCount = recordStream
            .explain(explanationMatches(allOf(
  ...
  public void testNonPortableIntermediateMutationPortableTransform() throws Exception {
    ...
    Map<String, Record<String>> resultMap = recordStream
        .explain(explanationMatches(allOf(
            serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(FILTER), op(FILTER), op(MUTATE_THEN_INTERNAL)))),            // Second filter is waypoint
            clientSideStripePipeline(containsOperations(op(FILTER), op(MAP), op(MAP), op(COLLECT_1))), // Mutate uses client-side map
            clientSideMergedPipeline(empty()))))
        .filter(TAXONOMIC_CLASS.value().is("mammal"))
  ...
  public void testPartiallyPortableIntermediateMutationPortableTransform() throws Exception {
    ...
    Map<String, Record<String>> resultMap = recordStream
        .explain(explanationMatches(allOf(
            serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(FILTER), op(FILTER), op(MUTATE_THEN), opAndArgs(MAP, "Tuple.second()")))),
            clientSideStripePipeline(containsOperations(op(COLLECT_1))),
            clientSideMergedPipeline(empty()))))
        .filter(TAXONOMIC_CLASS.value().is("mammal"))
  ...
  public void testNonPortableTerminalMutationPortableTransform() throws Exception {
    ...
    recordStream
        .explain(explanationMatches(allOf(
            serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(FILTER), op(FILTER), op(MUTATE)))),       // Second filter is waypoint
            clientSideStripePipeline(containsOperations(op(FILTER), op(FOR_EACH))), // Mutate uses client-side forEach
            clientSideMergedPipeline(empty()))))
        .filter(TAXONOMIC_CLASS.value().is("mammal"))
        .filter(r -> !r.getKey().equals("echidna"))               // Non-portable
        .mutate(write(OBSERVATIONS).longResultOf(OBSERVATIONS.longValueOr(0L).increment()));
  ...
  public void testPostMutationSorted() throws Exception {
    ...
    List<Record<String>> newlyEndangered = recordStream
            .explain(explanationMatches(allOf(
                    serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(FILTER), op(MUTATE_THEN)))),
                    clientSideStripePipeline(containsOperations(op(MAP), op(SORTED_1), op(COLLECT_1))),
                    clientSideMergedPipeline(empty()))))
        .filter(unseen)
  ...
  public void testMutableStreamSort() throws Exception {
         ...
         */
    {
      ...
      RecordStream<String> sortedRecordStream = recordStream
          .explain(explanationMatches(allOf(
              serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(FILTER)))),
              clientSideStripePipeline(containsOperations(op(SORTED_1), op(LIMIT), op(MAP), op(COLLECT_1))),
              clientSideMergedPipeline(empty()))))
          .filter(isMammal)
         ...
         */
    {
      ...
      RecordStream<String> sortedRecordStream = recordStream
          .explain(explanationMatches(allOf(
              ...
              clientSideStripePipeline(containsOperations(op(FILTER), op(SORTED_1), op(LIMIT), op(MAP), op(COLLECT_1))),
              clientSideMergedPipeline(empty()))))
  ...
  public void testNonPortableIntermediateDeletion() throws Exception {
    ...
    Map<String, Record<String>> resultMap = recordStream
        .explain(explanationMatches(allOf(
            serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(FILTER), op(FILTER), op(DELETE_THEN)))),            // Second filter is waypoint
            clientSideStripePipeline(containsOperations(op(FILTER), op(MAP), op(COLLECT_1))), // Delete uses client-side map
            clientSideMergedPipeline(empty()))))
        .filter(TAXONOMIC_CLASS.value().is("mammal"))
        .filter(r -> !r.getKey().equals("echidna"))               // Non-portable
        .deleteThen()
  ...
  public void testNonPortableTerminalDeletion() throws Exception {
    ...
    recordStream
        .explain(explanationMatches(allOf(
            serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(FILTER), op(FILTER), op(DELETE)))),       // Second filter is waypoint
            clientSideStripePipeline(containsOperations(op(FILTER), op(FOR_EACH))), // Delete uses client-side forEach
            clientSideMergedPipeline(empty()))))
        .filter(TAXONOMIC_CLASS.value().is("mammal"))
        .filter(r -> !r.getKey().equals("echidna"))             // Non-portable
        .delete();
    ...
    threadGone: {
      for (int i = 10; i > 0; i--) {
        boolean found = Arrays.stream(Diagnostics.getAllThreads())
            ...
            .anyMatch(name -> name.startsWith("PipelineProcessor"));
        if (!found) {
          System.out.format("PipelineProcessor thread discarded after %d ms (i=%d)%n", (10 - i) * 200, i);
          break threadGone;
        }
        Thread.sleep(200L);
      }
   ...
   * and reused before the close message for that pipeline processor is handled.  It was possible for a
   * close against a "finished" {@link PipelineProcessor PipelineProcessor} to cause the interruption of a
   * new {@code PipelineProcessor}.
   */
  @Test
   ...
   */
  @Test
  public void testRemoteStreamPreFetch() throws Exception {
    assumeThat(streamStrategy, is(INLINE));

    ObservableDatasetActiveEntity<String> observableActiveEntity = getObservableDatasetActiveEntity();
    ...
    // Force creation of the remote InlineElementSource and consume ONE element
    assertTrue(spliterator.tryAdvance(counter));

    Collection<PipelineProcessor> pipelineProcessors = getPipelineProcessors(observableActiveEntity);
    assertThat(pipelineProcessors.size(), is(1));
    @SuppressWarnings("unchecked") InlineElementSource<String, Record<String>> elementSource =
        (InlineElementSource<String, Record<String>>)pipelineProcessors.iterator().next();
  ...
  public void testStreamId() throws Exception {
    ...
    RecordStream<String> animalStream = streamStrategy.stream(writerReader);
    assertNull(((RemoteObject)animalStream).getStreamId());   // Not yet open

    Spliterator<Record<String>> spliterator = animalStream.spliterator();
    assertTrue(spliterator.tryAdvance(r -> {}));

    assertNotNull(((RemoteObject)animalStream).getStreamId());
  }

  @Test
  public void spliteratorExplainTest() throws Exception {
    DatasetWriterReader<String> access = dataset.writerReader();

    CompletableFuture<Object> explanation = new CompletableFuture<>();
    try (RecordStream<String> recordStream = streamStrategy.stream(access)) {
      List<String> result = recordStream.explain(explanation::complete)
          .explain(explanationMatches(allOf(
                  serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(FILTER)))),
                  clientSideStripePipeline(containsOperations(op(MAP), op(COLLECT_1))),
                  clientSideMergedPipeline(empty()))))
    ...
    assertThat(explanation.get(), notNullValue());
  }

  @Test
  public void fullExplainTestFullyTerminated() throws Exception {
    DatasetWriterReader<String> access = dataset.writerReader();

    CompletableFuture<Object> explanation = new CompletableFuture<>();
    try (RecordStream<String> recordStream = streamStrategy.stream(access)) {
      long mammalObservations = recordStream.explain(explanation::complete)
          .explain(explanationMatches(allOf(
                  serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(FILTER), op(MAP_TO_LONG), op(SUM)))),
                  clientSideStripePipeline(empty()),
                  clientSideMergedPipeline(empty()))))
  ...
  @Test
  public void fullExplainTestPartiallyPortable() throws Exception {
    DatasetWriterReader<String> access = dataset.writerReader();
    ...
    try (RecordStream<String> recordStream = streamStrategy.stream(access)) {
      long mammalObservations = recordStream.explain(explanation::complete)
          .explain(explanationMatches(allOf(
              serverSidePipeline(streamStrategy.ignoringPrefix(containsOperations(op(FILTER), op(MAP_TO_LONG)))),
              clientSideStripePipeline(containsOperations(op(LONG_FILTER), op(SUM))),
              clientSideMergedPipeline(empty()))))
          .filter(TAXONOMIC_CLASS.value().is("mammal"))
          .mapToLong(OBSERVATIONS.longValueOr(0L))
          .filter(x -> true)
  ...
  private <K extends Comparable<K>> ObservableDatasetActiveEntity<K> getObservableDatasetActiveEntity() {
    ...
    return (ObservableDatasetActiveEntity<K>)activeEntities.get(0);   // unchecked
  }
