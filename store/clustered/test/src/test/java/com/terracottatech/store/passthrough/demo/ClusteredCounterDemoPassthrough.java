 ...
 */
package com.terracottatech.store.passthrough.demo;

import org.hamcrest.Matcher;
import org.junit.Test;

import com.terracottatech.store.embedded.demo.CounterDemo;
import com.terracottatech.store.server.PassthroughTest;
...
/**
 * Executes the {@link CounterDemo} using passthrough.
 */
public class ClusteredCounterDemoPassthrough extends PassthroughTest {

  @Test
  public void testCounterDemo() throws Exception {
    CounterDemo demo = new CounterDemo();

    StringWriter writer = new StringWriter();

    demo.runClustered(URI.create("passthrough://stripe"), "offheap", writer);

    List<String> lines = asList(writer.toString().split("\n"));

    @SuppressWarnings("unchecked")
    Matcher<Iterable<String>> matcher = hasItems(
