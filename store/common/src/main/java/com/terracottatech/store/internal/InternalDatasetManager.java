...
public interface InternalDatasetManager extends DatasetManager {
  ...
  /**
   * @return The management alias used to identify this object in the management registry
   */
  String getDatasetManagerAlias();

  /**
   * @return A management registry used to register objects and expose settings and stats
   */
  ...
  /**
   * @param observer observer used to receive notifications and statistics collected
   */
  void setObserver(ManageableObserver observer);
