...
public class ToDoubleFunctionAdapter<T> implements IntrinsicBuildableComparableFunction<T, Double> {

  private final IntrinsicToDoubleFunction<T> delegate;

  public ToDoubleFunctionAdapter(IntrinsicToDoubleFunction<T> delegate) {
    this.delegate = delegate;
  }

  public IntrinsicToDoubleFunction<T> getDelegate() {
    return delegate;
  }

  @Override
  public IntrinsicType getIntrinsicType() {
    return FUNCTION_TO_DOUBLE_ADAPTER;
  }
  ...
  public boolean equals(Object o) {
    ...
    ToDoubleFunctionAdapter<?> that = (ToDoubleFunctionAdapter<?>) o;
