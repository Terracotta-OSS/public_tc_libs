...
public interface IntrinsicBuildableToIntFunction<T> extends IntrinsicToIntFunction<T>, BuildableToIntFunction<T> {
  ...
  @Override
  default IntrinsicBuildableToIntFunction<T> add(int operand) {
    return Add.Int.add(this, operand);
  }

  @Override
  default IntrinsicBuildableToIntFunction<T> multiply(int operand) {
    return Multiply.Int.multiply(this, operand);
  }

  @Override
  default IntrinsicBuildableToIntFunction<T> divide(int operand) {
    return Divide.Int.divide(this, operand);
  }
}
