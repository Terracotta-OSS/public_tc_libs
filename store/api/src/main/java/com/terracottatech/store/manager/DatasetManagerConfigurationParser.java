...
public interface DatasetManagerConfigurationParser {
  DatasetManagerConfiguration parse(URL configurationLocation) throws DatasetManagerConfigurationException;
  ...
  static DatasetManagerConfigurationParser getDatasetManagerConfigurationParser() {
    ServiceLoader<DatasetManagerConfigurationParser> parsers =
        ServiceLoader.load(DatasetManagerConfigurationParser.class, DatasetManagerConfigurationParser.class.getClassLoader());

    DatasetManagerConfigurationParser datasetManagerConfigurationParser = null;
    for (DatasetManagerConfigurationParser parser : parsers) {
      if (datasetManagerConfigurationParser == null) {
        datasetManagerConfigurationParser = parser;
      } else {
