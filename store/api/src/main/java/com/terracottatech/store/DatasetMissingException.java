...
public class DatasetMissingException extends StoreException {
  ...
  public DatasetMissingException(Throwable cause) {
    super(cause);
  }

  public DatasetMissingException(String message) {
    super(message);
  }

  public DatasetMissingException(String message, Throwable cause) {
    super(message, cause);
  }
}
