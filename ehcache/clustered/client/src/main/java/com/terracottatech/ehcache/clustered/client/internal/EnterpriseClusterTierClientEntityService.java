...
/**
 * EnterpriseClusterTierClientEntityService
 */
@OverrideService("org.ehcache.clustered.client.internal.store.ClusterTierClientEntityService")
public class EnterpriseClusterTierClientEntityService implements
    EntityClientService<InternalClusterTierClientEntity, ClusterTierEntityConfiguration, EhcacheEntityMessage, EhcacheEntityResponse, ClusterTierUserData> {
  ...
  @Override
  public InternalClusterTierClientEntity create(EntityClientEndpoint<EhcacheEntityMessage, EhcacheEntityResponse> endpoint,
