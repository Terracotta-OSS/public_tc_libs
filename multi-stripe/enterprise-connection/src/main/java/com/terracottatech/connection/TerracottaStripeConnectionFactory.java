...
public class TerracottaStripeConnectionFactory implements StripeConnectionFactory {
  @Override
  public Connection createStripeConnection(int stripeIndex, EndpointConnector endpointConnector, URI uri, Properties properties) throws ConnectionException {
    TerracottaConnectionService connectionService = new TerracottaConnectionService(endpointConnector);
