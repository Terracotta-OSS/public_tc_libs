...
public class BackupSingleStripeIT extends AbstractBackupIT {

  @ClassRule
  public static final EnterpriseCluster CLUSTER = newCluster(1).withPlugins(resourceConfigWithBackupPath(backupFolder.getRoot().getAbsolutePath())).build(true);
